...
export default function Hero() {
  ...
  const status = useMemo(() => {
    ...
    if (isLikelyEthAddress(v))
      return { kind: "ok" as const, msg: "Looks valid." };
    return {
      kind: "err" as const,
      msg: "Enter a valid 0x address (40 hex chars).",
    };
  }, [value, touched]);
  ...
  const submit = () => {
    ...
    navigate(`/dashboard?address=${encodeURIComponent(address)}&range=30d`);
  };
        ...
        <div className="mt-14 grid items-center gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-300">
              Turn raw on-chain transactions into clear insights:
              inflows/outflows, counterparties, and behavior patterns — built
              for analysis, not speculation.
            </p>
            ...
            <div className="mt-7">
              <div className="flex flex-col gap-3 sm:flex-row">
                <div className="relative flex-1">
                  ...
                  >
                    {status.msg ||
                      "Tip: Paste an Ethereum 0x address (40 hex characters)."}
                  </p>
